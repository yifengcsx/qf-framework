...
public final class StringUtils {
	 ...
	 * @throws ArgumentError if the width is too small
	 */
	 ...
	 * @return the trimmed string
	 * @throws ArgumentError if you try to remove more than one character
	 */
	public static function leftTrimForChar(string:String, char:String):String {
		if (char.length != 1) {
			throw new ArgumentError("The Second Attribute char [" + char + "] must exactly one character.");
		}
